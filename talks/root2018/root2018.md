...
## Making C++ faster:
- Use idioms and patterns that are both efficient and fast
- Minimize abstractions faced by the compiler
- Data-oriented design to fully use every cache line paid for
- Benchmark endlessly&mdash;CPUs are impossible to predict
...
But these are also really well covered by the series of talks I've been giving
at CppCon, so in some ways this information isn't as scattered.
